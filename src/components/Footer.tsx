...
const Footer = () => {
  return (
    <>
      <footer className="border-b bg-dark-500 md:px-10 border-b-slate-800">
        <div className="flex flex-col items-center py-12 md:flex-row">
      ...
      <footer className="px-3.5 sm:px-7 bg-dark-500 xl:px-10">
        <div className="flex flex-col items-start py-12 lg:items-center max-md:gap-y-3 md:flex-row ">
